...
import robot4 from '../assets/robot4.jpg'
    ...
    >
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          ...
          We specialize in creating custom software experiences that elevate your brand and engage your audience. Let's bring your vision to life.
          </p>
